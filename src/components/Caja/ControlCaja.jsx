...
import { getReporteVentasCategoriaHoy, obtenerVentasHoy } from '../Redux/actions/ventasActions';
...
const ControlCaja = () => {
    ...
    const ventasHoy = useSelector((state) => state.ventas.ventasHoy);
